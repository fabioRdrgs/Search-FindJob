...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 20 mai 2021 à 13:08
...
--
-- Base de données : `SearchAndFindDB_Public`
--
CREATE DATABASE IF NOT EXISTS `SearchAndFindDB_Public` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `SearchAndFindDB_Public`;
