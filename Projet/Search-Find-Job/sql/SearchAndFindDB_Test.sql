...
--
-- Base de données : `SearchAndFindDBTest`
--
CREATE DATABASE IF NOT EXISTS `SearchAndFindDBTest` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `SearchAndFindDBTest`;
